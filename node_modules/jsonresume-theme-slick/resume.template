...
<html>
	...
	<div class="container-fluid" id="resume">
			...
			<div id="card" class="row">
				<div class="col-xs-3 col-sm-4" style="height:0;">
					{{#if picture}}
					<img class="img-responsive" src="https://scontent.fdel1-1.fna.fbcdn.net/hphotos-xfp1/t31.0-8/325432_4163116070659_729661660_o.jpg" style="width:208px;margin:auto;"/>
					{{/if}}
				</div>
					...
					<section id="basics">
						...
						<section id="profiles">
							...
							<div class="item" style="width:48%">
								{{#if network}}
								<icon class="fa fa-{{class}}"></icon> {{url}}
								{{/if}}
							</div>
							{{/each}}
						</section>
